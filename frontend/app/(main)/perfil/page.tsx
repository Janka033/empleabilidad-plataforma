...
const ESTADO_CONFIG: Record<string, { label: string; bg: string; text: string; icon: string; color: string }> = {
    enviada:    { label: "Enviada",       bg: "bg-gray-100",   text: "text-gray-600",    icon: "schedule",      color: "bg-gray-200"    },
...
const UNIVERSIDADES = [
    ...
    "Universidad del Quindío","Universidad La Gran Colombia","SENA","Otra",
];
const PROGRAMAS = [
    "Ingeniería de Software","Ingeniería de Sistemas","Administración de Empresas",
    "Diseño Gráfico","Contaduría Pública","Derecho","Otro",
];
...
export default function PerfilPage() {
    ...
    const [tab,              setTab]               = useState<"postulaciones" | "perfil" | "notificaciones">("postulaciones");
    ...
    }, [router, fetchPerfil, fetchPostulaciones, fetchNotificaciones]);
        ...
        try {
            const res = await fetch(`${API_URLS.perfiles}/perfiles/me`, {
                ...
                body: JSON.stringify({
                    ...
                    semestre:    editForm.semestre ? Number(editForm.semestre) : undefined,
                                                ...
                                                <div className="flex items-start gap-3">
                                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${
                                                        n.tipo === "contratado" ? "bg-emerald-100" :
                                                            n.tipo === "postulacion_nueva" ? "bg-blue-100" : "bg-gray-100"
                                                    }`}>
                            <span className={`material-symbols-outlined text-[16px] ${
                                n.tipo === "contratado" ? "text-emerald-600" :
                                    n.tipo === "postulacion_nueva" ? "text-blue-600" : "text-gray-600"
                            }`}>
            ...
            <main className="flex-1 w-full max-w-4xl mx-auto px-4 md:px-8 pt-20 pb-12 flex flex-col gap-6">
                    ...
                    Contratado · {perfil.empresa_contratante}
                        ...
                        <div className="flex flex-col items-center gap-2 shrink-0">
                            <div className="relative w-16 h-16">
                                ...
                                <span className="absolute inset-0 flex items-center justify-center text-sm font-bold text-gray-900">{perfil.completitud}%</span>
                            </div>
                            <span className="text-xs text-gray-500">Perfil</span>
                            <button
                                onClick={() => { setEditMode(true); setTab("perfil"); }}
                                className="flex items-center gap-1 text-xs font-semibold px-3 py-1.5 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors"
                            >
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center justify-between">
                            <h2 className="text-base font-semibold text-gray-800">
                                ...
                                {!loadingPostul && <span className="ml-2 text-sm font-normal text-gray-400">({postulaciones.length})</span>}
                            </h2>
                                ...
                                {postulaciones
                                    ...
                                    return (
                                        <div key={p.id} className={`bg-white rounded-2xl border shadow-sm hover:shadow-md transition-shadow overflow-hidden ${
                                            p.esFavorita ? "border-orange-300 ring-1 ring-orange-200" : "border-gray-200"
                                        }`}>
                                                ...
                                                <div className="flex items-start justify-between gap-3">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-xl bg-gray-100 border border-gray-200 flex items-center justify-center shrink-0">
                                                            <span className="font-bold text-gray-700">{(p.vacanteEmpresa ?? "?").charAt(0).toUpperCase()}</span>
                                                        </div>
                                                        <div>
                                                            <p className="font-semibold text-gray-900 text-sm">{p.vacanteTitle ?? "Cargando..."}</p>
                ...
                {tab === "perfil" && (
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center justify-between">
                            <h2 className="text-base font-semibold text-gray-800">Datos académicos</h2>
                            {!editMode && (
                                <button
                        ...
                        {loadingPerfil ? (
                            ...
                            <form onSubmit={handleSavePerfil} className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex flex-col gap-5">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <input
                                            ...
                                            className="border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-gray-500"
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <select
                                            ...
                                            className="border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-gray-500 bg-white"
                                        >
                                    ...
                                    {/* Semestre */}
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-sm font-semibold text-gray-700">Semestre actual</label>
                                        <select
                                ...
                                <div className="flex flex-col gap-2">
                                    <label className="text-sm font-semibold text-gray-700">Habilidades técnicas</label>
                                    ...
                                    <div className="flex gap-2 mt-1">
                                        <input
                                            ...
                                            className="flex-1 border border-gray-300 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-gray-500"
                                        />
                                ...
                                {notificaciones.map((n) => (
                                    <button
                                        ...
                                        className={`w-full text-left bg-white rounded-2xl border shadow-sm hover:shadow-md transition-all p-5 flex items-start gap-4 ${
                                            !n.leida ? "border-orange-200 bg-orange-50" : "border-gray-200"
                                        }`}
                                    >
                            ...
                            n.tipo === "postulacion_nueva" ? "person_add" : "update"}
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between gap-2">
                                                <p className={`text-sm font-semibold ${!n.leida ? "text-gray-900" : "text-gray-600"}`}>{n.titulo}</p>
